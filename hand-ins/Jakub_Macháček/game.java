...
public class backup{
   ...
   public static void main(String[] args) {
     ...
     // note
      ...
      if (questionNumber == 1) {
        ...
        System.out.println("What do you want to do? \n 1. Come closer\n 2. Kill him fast! (either way, you have no clue what's going to happen)");
        questionNumber = input.nextInt(); 
        while (questionNumber != 1 && questionNumber != 2 ){
           System.out.println("Please choose properly!");
           questionNumber = input.nextInt();}    
        if ( questionNumber == 1) {
           System.out.println("You are slowly coming to the deer. He is not moving, just looking at you. Suddenly, you step on a branch on the ground.");
           System.out.println("Deer, probably in panic, started to run towards you, now he is really close! You don't know why you can't move and dodge him.");
           System.out.println("He ran through your body! You felt a huge hit in your chest but not a single injury! This had to be a blessing! (you are 30% more powerful now)");
           coefficientDamage *= 0.7;
           coefficientHealth *= 1.3;
           playerR *= 1.3;
           playerHP *= 1.3;
           System.out.println("You have " + playerR + " " + playerResource + " and " + playerHP + " health points left.");
           }
        else {
           System.out.println("You decided to kill the animal now! You grab your" + playerWeapon + "from your back. As soon as you do that, the deer disappears!");        
           }
        System.out.println("You don't know what happened and you are not going to think much about it. You need to find your friend!");
        pressEnterToContinue();
        castlePic();
        System.out.println(" ");
        System.out.println("You are almost there! You approach a destroyed gate of the castle. You can hear some voices so you are really quiet and careful.");
        System.out.println("Now you stand behind the corner. You can clearly hear: \"I hope master will be happy with that man we brought!");
        pressEnterToContinue();
        System.out.println("Sorry for not completing the game, if you like it, just let us know, we will do our best to finish it.");
        System.out.println("Thank you for playing! You decided to save your friend, you are a good and brave" + pClass);
   ...
   public static void introPic() {
      System.out.println("WIZARDWIZARDWIZARDWIZARDWIZARDWIzzzWelcomeStrangeRaaaDWIZARDWIZARDWIZARDWIZARD");
      System.out.println("WIZARDWIZARDWIZARDWIZARDWIZAR..::::::::::::::::..IZARDWIZARDWIZARDWIZARDWIZARD");
      System.out.println("WIZARDWIZARDWIZARDWIZARD.::::::::::::::::::::::::::::.WIZARDWIZARDWIZARDWIZARD");
      System.out.println("WIZARDWIZARDWIZARDWI.:::::::::'mmMMMMMMMMMMMMmm`:::::::::.RDWIZARDWIZARDWIZARD");
      System.out.println("WIZARDWIZARDWIZAR.:::::::'mMMMMMMMMMMMMMMMMMMMMMMMMm`:::::::.IZARDWIZARDWIZARD");
      System.out.println("WIZARDWIZARDWI.::::::'mMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
      System.out.println("WIZ:::.MMMMMMMMMMMMMMMMMMMMMMM          mMMMMMMMMM            mMMMMMMMM':::ARD");
      System.out.println("WIZ`MMMMM             MMMMMMM         mMMMMMMMMM              MMMMMMMMm:::'ARD");
      System.out.println("WIZA                       M        mMMMMMMMMM               mMMMMMMMM'::'ZARD");
      System.out.println("WI                                mMMMMMMMMM                 MMMMMMMM,::.IZARD");
      System.out.println("W  ZAMMMm                       mMMMMMMMMM                   MMMMMMM,:::'IZARD");
      System.out.println(" IZARD`::Mm                   MMMMMMMMMM        mMMMMMMMMMMMMMMMMMM,:::'WIZARD");
      System.out.println("WIZARDW`:::M               mMMMMMMMMMMM     mMMMMMMMMM      MMMMMMMm::'DWIZARD");
      System.out.println("WIZARDWI`::MM           mMMMMMMMMMMMMM   mMMMMMMMMMMM             MM:'RDWIZARD");
      System.out.println("WIZARDWIZAM MM       mMMMMMMMMMMMMMMM  mMMMMMMMMMMMMMmmmmmmmmmmmMMM:ZARDWIZARD");
      System.out.println("WIZARDWIZA   Mm   mMMMMMMMMMMMMMMMMM  mMMMMMMMMMMMMMMMMMMMMMM'::::'IZARDWIZARD");
      System.out.println("WIZARDWIZ     M mMM.MMMMMMMMMMMMMMMm mMMMMMMMMMMMMMMMMMMMMM.::::'DWIZARDWIZARD");
      System.out.println("WIZARDWI    DWMm`:::: MMMMMMMMMMMMMm MMMMMMMMMMMMMMMMMMM .::::'ARDWIZARDWIZARD");
      System.out.println("WIZARDW   ARDWIZAR`:::::. MMMMMMMMMMmMMMMMMMMMMMMMMM .:::::'WIZARDWIZARDWIZARD");
      System.out.println("WIZARDW  ZARDWIZARDWI`:::::::.  MMMMMMMMMMMMMM  .::::::::'RDWIZARDWIZARDWIZARD");
      System.out.println("WIZARDW  ZARDWIZARDWIZAR`::::::::::::::::::::::::::::'WIZARDWIZARDWIZARDWIZARD");
      System.out.println("WIZARDWIZARDWIZARDWIZARDWIZAR``::::::::::::::::''IZARDWIZARDWIZARDWIZARDWIZARD");
      System.out.println("WIZARDWIZARDWIZARDWIZARDWIZARDWIZARDWIZARDWIZARDWIZARDWIZARDWIZARDWIZARDWIZARD");
      }
      
      
   public static void magePic () {
      System.out.println("                                   /  \\ ");
      System.out.println("                                  |    |");
      System.out.println("                                --:'''':--");
   ...
   public static void castlePic () {
      ...
      System.out.println("                 | ,   | .    .     .      . |    .|");
      System.out.println("                 |   . |  .     . .   .  ,   |.    |");
      System.out.println("     ___----_____| .   |.   ,  _______   .   |   , |---~_____");
      System.out.println("_---~            |     |  .   /+++++++\\    . | .   |         ~---_");
      System.out.println("                 |.    | .    |+++++++| .    |   . |              ~-_");
